...
namespace FixRushGame
{
    public abstract class Vehicle : MonoBehaviour
    {
        ...
        [SerializeField] private FixRushGame.IssueType[] _issues;

        public FixRushGame.IssueType[] Issues { get { return _issues; } internal set { _issues = value; } }
        ...
        public void Fix() { FixRushGame.VManager.Instance.RemoveVehicle(this); }

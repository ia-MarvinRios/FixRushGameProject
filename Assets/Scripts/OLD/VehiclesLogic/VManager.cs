...
namespace FixRushGame
{
    public class VManager : MonoBehaviour
    {
        ...
        private static FixRushGame.IssueType[] _allIssues = (FixRushGame.IssueType[])System.Enum.GetValues(typeof(FixRushGame.IssueType));
        List<FixRushGame.IssueType> selected = new List<FixRushGame.IssueType>();
        ...
        FixRushGame.IssueType[] AssignIssues(Vehicle v)
        {
            selected.Clear();
            ...
            for (int i = 0; i < t; i++)
            {
                FixRushGame.IssueType issue = GetRandomIssue();
        ...
        FixRushGame.IssueType GetRandomIssue()
        {
        ...
        public IEnumerator MoveToEndPoint(NavMeshAgent agent, FixRushGame.Car car)
        {

...
public class Car : Vehicle, IInteractable
{
    [Header("Car Settings")]
    ...
    internal CarNetwork CarNetwork { get; private set; }
    ...
    {
        CarNetwork = GetComponent<CarNetwork>();
        IsGatoed = false;
    ...
    {
        Debug.Log($"[Car] {entity.FocusedObj} {entity}");
        CurrentIssue.HandleInteraction(entity.FocusedObj, entity);
    }
    ...
    internal void MoveCarToEndPoint(Vehicle v)
    {
        VehicleNetwork.MoveCarToEndPoint(v);
    }
    ...
    public void PlaceGato(AuxPlayer player, int gatoRootIndex)
    {
        ...
        Debug.Log($"[Car] Gato placed. Pivot: {pivotWorld} | Angle: {angle * sign}");
    }

    public void RemoveGato(int gatoRootIndex, AuxPlayer entity)
    {
        ...
        // Release gato
        root.Object.GetComponent<Gato>().PickUpGato(entity);
        root.Object = null;
        IsGatoed = false;

        Debug.Log($"[Car] Gato removed. Pivot: {pivotWorld} | Angle: {-angle * sign}");
    }
